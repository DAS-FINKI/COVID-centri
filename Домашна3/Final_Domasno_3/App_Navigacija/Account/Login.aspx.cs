...
namespace App_Navigacija.Account
{
    public partial class Login : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                naslov.Text = "Ве молиме најавете се / регистрирајте се за да продолжeте";

                RegisterHyperLink.Text = "Регистрирај се";

                Button1.Text = "Најави се";

                zapomni.Text = "Запомни?";
            ...
            else if ((String)Session["Jazik"] == "eng")
            {
                ...
                naslov.Text = "Please log in / register to continue";

                RegisterHyperLink.Text = "Register";

                Button1.Text = "Log in";

                zapomni.Text = "Remember?";
